...
public class StudentGetAllTests {
    ...
    void whenRequestingStudentList_thenReturnListOfStudentPaginatedSuccessfully() throws Exception {
        ...
        mockMvc.perform(get("/student?page=0&pageSize=4"))
                ...
                .andExpect(jsonPath("$.content[2].university", is("UNI 2")))
                .andExpect(jsonPath("$.content[2].graduation", is("Grad 2")))
                ...
                .andExpect(jsonPath("$.content[3].university", is("UNI 3")))
                .andExpect(jsonPath("$.content[3].graduation", is("Grad 3")));
